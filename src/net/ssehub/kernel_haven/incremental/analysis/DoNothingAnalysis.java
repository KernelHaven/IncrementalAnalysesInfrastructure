...
/**
 * 
 * An Analysis that really does nothing in terms of a real Analysis. This only
 * runs the parts of an incremental analysis that need to be run before any core
 * analyis can be started. However it does not perform any analysis on the
 * models after those parts.
 * 
 * If you want to implement an incremental analysis, use the HybridCache that is
 * the result of the {@link IncrementalPostExtraction}
 * 
 * @author moritz
 */
