...
public class IncrementalAnalysisSettings {
	...
	// CHECKSTYLE:OFF
	public static final Setting<File> SOURCE_TREE_DIFF_FILE = new Setting<>("incremental.input.source_tree_diff", FILE,
			true, "git.diff",
	...
	public static final Setting<String> VARIABILITY_ANALYZER_CLASS_NAME = new Setting<>(
			"incremental.variability_analyzer.class_name", STRING, true,
