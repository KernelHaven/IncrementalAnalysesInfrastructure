...
public abstract class InputFilter {
	 ...
	 */
	public InputFilter(File sourceDirectory, DiffFile diffFile, Pattern fileRegex, boolean includeDeletions)
			throws IOException {
	 ...
	 * directory where the relvant files are stored and diffFile to describe newly
	 * introduced changes between the current version of files in sourceDirectory
